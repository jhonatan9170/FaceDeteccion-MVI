...
extension UIImage {
    ...
    static let imagePlaceholder = UIImage(named: "placeholder") ?? UIImage()
...
extension UIImage {
    ...
    func detectFaces(completion: @MainActor @escaping ([VNFaceObservation]?) -> ()) async {
        
        guard let image = self.cgImage else { return await completion(nil) }
        ...
        guard let observations =
            ...
            return await completion(nil)
        }
        await completion(observations)
    }
